 ...
 * PIDOutput
 */
public class robovikingPIDController implements LiveWindowSendable {
	...
	private class PIDTask extends TimerTask {
		...
		public PIDTask(robovikingPIDController robovikingPIDController) {
			if (robovikingPIDController == null) {
				throw new NullPointerException("Given PIDController was null");
			}
			m_controller = robovikingPIDController;
		}
		@Override
		public void run() {
	 ...
	 */
	public robovikingPIDController(double Kp, double Ki, double Kd, double Kf,
...
//				m_result = m_P * m_error + m_I * m_totalError + m_D * (m_error - m_prevError) + m_setpoint * m_F;
	...
	/**
	 * Reset the error accumulated over time for the Integral calculation
	 */
